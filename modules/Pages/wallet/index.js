...
const Trans=({date})=>{
    ...
    return(
        <div className={clsx(classes.borderInBetween,'flex flex-row justify-content-between pt-2 pb-2')}>
            <div className={classes.summaryHistLbl}>
                {date}
            </div>
            <div>
                <Button variant={"text"} className='min-w-0 p-0'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="vertical_align_bottom_24px">
                            <path id="icon/editor/vertical_align_bottom_24px" fill-rule="evenodd" clip-rule="evenodd" d="M13 13H16L12 17L8 13H11V3H13V13ZM4 21V19H20V21H4Z" fill="black" fill-opacity="0.38"/>
                        </g>
                    </svg>
                </Button>
            </div>
