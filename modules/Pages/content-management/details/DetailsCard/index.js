...
const DetailsCard = ({title, contentTitle, views, likes, comments, ownership, category, date, contentType}) =>{
                ...
                <CmtCardContent className='p-3'>
                    ...
                    <div className='mt-5'>
                        <div className='flex flex-row'>
                            <div>
                                <img style={{display: 'inline-block'}} alt={'content'} src={'/images/dashboard/content_details.png'}/>
                            </div>
                            <div className='ml-3 flex flex-column justify-content-between'>
                                ...
                                <div className={classes.infoLabel}>
                                    Ownership :
                                    <span style={{color: 'black'}}>{ownership}</span>
                                </div>
                                <div className={classes.infoLabel}>
                                    Category :
