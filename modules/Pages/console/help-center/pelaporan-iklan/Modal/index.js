          ...
          {type === 'ditangguhkan' ? (
            <div>
              <Stack direction={'column'} spacing={2}>
                <Typography fontWeight={'bold'}>Kamu Akan Menangguhkan Konten Iklan Ini?</Typography>
            ...
            <div>
              <Stack spacing={1}>
                <Typography fontWeight={'bold'}>Kamu Tidak Menangguhkan Konten Iklan Ini</Typography>
