      ...
      <PageContainer heading="Beranda">
        ...
        <GridContainer>
          <Grid item xs={12} sm={6} md={4}>
            <ActiveUsersCard jumlah="234" title="Pengguna Aktif sekarang" color="#0062FF" background={['#E2EEFF -18.96%', '#FFFFFF 108.17%']} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <ActiveUsersCard jumlah="543" title="Pengguna Aktif 7 hari" color="#4200FF" background={['#E2E3FF -18.96%', '#FFFFFF 108.17%']} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <ActiveUsersCard jumlah="1024" title="Pengguna Aktif 30 Hari" color="#FFA601" background={['#FFF2E2 -18.96%', '#FFFFFF 108.17%']} />
          </Grid>
