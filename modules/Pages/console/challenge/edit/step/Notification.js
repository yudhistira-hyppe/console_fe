...
import { CloudUpload, Edit, InfoOutlined } from '@material-ui/icons';
import {
  Avatar,
  Box,
  Card,
      ...
      <Stack direction="column" spacing={3}>
        ...
        <Stack direction="column" spacing={1}>
          ...
          <Stack direction="row" spacing={3}>
            <label htmlFor="banner-search" style={{ position: 'relative' }}>
              <Box
                style={{
                  width: 343,
                  height: 103,
        ...
        <Stack direction="column" spacing={1}>
          ...
          <Stack direction="row" spacing={3}>
            <label htmlFor="banner-popup" style={{ position: 'relative' }}>
              <Box
                style={{
                  width: 326,
                  height: 326,
