...
const JualBeliCard = ({ title, amount, progress, children, handlePayload }) => {
      ...
      <Stack direction="row" alignItems="center" gap={1} position="relative" style={{ height: 40 }}>
        ...
        <Popover
          ...
          <Box width={200} p="15px 20px" color="#ffffff" bgcolor="#282828" borderRadius="4px">
            Jumlah pendapatan yang dihasilkan pada jual beli konten dalam kurun waktu tertentu
          </Box>
        </Popover>
      </Stack>
      <Select
