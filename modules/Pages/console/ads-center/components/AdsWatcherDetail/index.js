      ...
      <Card className={classes.cardRoot}>
        <Stack
          ...
          <Stack direction="row" spacing={1}>
            <Typography fontFamily="Lato">Penonton</Typography>
            <Tooltip placement="top">
              <Info fontSize="small" htmlColor="rgba(0, 0, 0, 0.38)" />
            </Tooltip>
          </Stack>

          <Typography fontFamily="Lato">503 Pengguna</Typography>
        </Stack>
            ...
            <Stack
              ...
              <div>
                <Typography fontFamily="Lato">
                  <span style={{ fontWeight: 'bold' }}>{el.name}</span> telah menonton iklan ini
                </Typography>

                <Typography fontFamily="Lato" variant="caption" color="rgba(0, 0, 0, 0.38)">
                  {el.watchDate}
                </Typography>
              </div>
            </Stack>
