...
const AdsButtonDropdown = ({ status, setStatus, setShowModal, showModal, buttonColor, setButtonColor }) => {
              ...
              <MenuList
                ...
                onKeyDown={handleListKeyDown}>
                  ...
                  >
                    ...
                    <Chip 
                      label="Dijadwalkan" 
                      className={`${classes.lato} ${classes.bold} ${classes.scheduledBadge}`} 
                    /> 
                  </MenuItem>
                  ...
                  >
                    ...
                    <Chip 
                      label="Ditolak" 
                      className={`${classes.lato} ${classes.bold} ${classes.deniedBadge}`} 
                    /> 
                  </MenuItem>
              </MenuList>
            </ClickAwayListener>
