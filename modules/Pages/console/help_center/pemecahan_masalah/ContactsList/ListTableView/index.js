...
import { Table, TableBody, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Paper, Box, Typography, TextField, Button } from '@material-ui/core';
            ...
            {dialogOpen &&
                <Box className={classes.replyDialog}>
                    ...
                    <Box display="flex" style={{padding:20,justifyContent:'space-between'}}>
                        <Box>
                            <Button variant='contained' startIcon={<SendIcon />} color="primary">Send</Button>
