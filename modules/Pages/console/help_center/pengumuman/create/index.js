...
import { Box, Button, Checkbox, FormControl, FormControlLabel, FormGroup, Grid, Radio, RadioGroup, Switch, TextField } from '@material-ui/core';
...
const breadcrumbs = [
    ...
    { label: 'Pengumuman', link: '/console/help_center/pengumuman' },
                ...
                <GridContainer>
                    ...
                    <Grid item xs={12} lg={3}>
                        ...
                        { isButtonPilihPenerimaClicked &&
                            ...
                            <RadioGroup aria-label="gender" name="gender1" value={penerima} onChange={(e) => setPenerima(e.target.value)}>
                                <FormControlLabel value="all" control={<Radio />} label="Semua pengguna" />
                                <FormControlLabel onClick={() => router.push('/console/help_center/pengumuman/pilih_pengguna')} value="selected" control={<Radio />} label="Pengguna pilihan" />
                            </RadioGroup>
                            </FormControl>
                        }
                    </Grid>
                    ...
                    <Grid item xs={12} lg={4}>
                        <FormControl component="fieldset">
                            <FormGroup>
                                <FormControlLabel value="push" control={<Switch color="primary" />} label="Pemberitahuan Dorong" labelPlacement="start" />
                                <FormControlLabel value="inapp" control={<Switch color="primary" />} label="Pemberitahuan Dalam-App" labelPlacement="start" />
                                <FormControlLabel value="page" control={<Switch color="primary" />} label="Halaman Pemberitahuan" labelPlacement="start" />
                                <FormControlLabel value="email" control={<Switch color="primary" />} label="Email" labelPlacement="start" />
                            </FormGroup>
                        </FormControl>
                    </Grid>
