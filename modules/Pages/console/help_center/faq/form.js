...
import { updateSelectedFaq } from 'redux/actions/helpCenterAction';
...
const ConsoleAddFaqComponent = () => {
  ...
  const submitFaq = () => {
      console.log(title);
      console.log(content);
      dispatch(updateSelectedFaq({title,content}));
            ...
            <CmtCardContent>
                <GridContainer>
                    ...
                    <Grid item xs={6} lg={6} className={classes.btnBottomAction}>
                        <Button variant="contained" color="primary" onClick={submitFaq}>
                            Simpan
                        </Button>
                    </Grid>
                </GridContainer>
