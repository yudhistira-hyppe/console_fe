...
const ListEmoji = ({ category, setTab }) => {
  ...
  const handleDragEnd = (result) => {
    ...
    updateSticker(formData).then((res) => {
      if (res?.error) {
        ...
        toast.success('Berhasil mengubah urutan emoji');
      }
    });
  };
          ...
          <Paper style={{ width: '100%', height: 950 }}>
            <Stack direction="column" width="100%">
              <Stack direction="row" style={{ width: '100%', borderBottom: '1px solid #21212114', padding: 24 }}>
                <Typography style={{ width: '40%', fontSize: 14, paddingLeft: 40 }}>Nama Emoji</Typography>
              ...
              {refreshTable || loadingSticker ? (
                ...
                <Stack direction="column" alignItems="center" justifyContent="center" height={880} width="100%" gap={2}>
                  <Typography style={{ fontFamily: 'Normal' }}>Tidak ada data emoji dengan kategori ini</Typography>
                </Stack>
              )}
            </Stack>
          </Paper>
