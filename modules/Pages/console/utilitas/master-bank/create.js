...
import { useCreateMasterBankMutation } from 'api/console/utilitas/bank';
...
const CreateMasterBank = () => {
  ...
  const [createBank, { isLoading: loadingCreate }] = useCreateMasterBankMutation();
  ...
  const handleSubmit = (e) => {
    ...
    createBank(formData).then((res) => {
      if (res?.error) {
        ...
        toast.success('berhasil menambahkan bank', { duration: 3000 });
      }
    });
  };
...
export default CreateMasterBank;
