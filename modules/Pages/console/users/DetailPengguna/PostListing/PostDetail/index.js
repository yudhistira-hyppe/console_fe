...
const PostDetail = ({ selectedContent, showContentList }) => {
    ...
    <CmtCard>
      ...
      <Box className={classes.carouselRoot}>
        {selectedContent.mediaType === 'video' ? (
          ...
          <CmtCardMedia className={classes.imageRoot} image={getMediaUri(selectedContent)} title={selectedContent.title} />
        )}
      </Box>
      <Box p={6}>
